export type ColorMap = {
    general: { success: string; warning: string; error: string; text_on_background: string; };
    legend_colors_array: string[];
    group_colors: {
        B_inactive: string;
        B_background: string;
        A_inactive: string;
    ...
    plot_colors: { paperColor: string; gridColor: string; plotColor: string; };
    legend_colors: { a: string; b: string; c: string; d: string; e: string; f: string; connecting_line: string; };
};
 ...
 * @private
 */
function _readColorMap(): ColorMap {
